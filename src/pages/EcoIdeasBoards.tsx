                  ...
                  <div key={subStrategy.id} className="mb-6">
                    ...
                    <ul className="list-none space-y-1">
                      {subStrategy.guidelines.map((guideline, guidelineIndex) => {
                        ...
                        const isSixthOverallGuideline = strategyIndex === 0 && subStrategyIndex === 0 && guidelineIndex === 5; // New condition for 6th guideline
                        ...
                        } else if (isSixthOverallGuideline) { // Apply new link here
