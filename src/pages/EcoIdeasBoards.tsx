...
import { getStrategyPriorityForDisplay, getPriorityTagClasses } from '@/utils/lcdUtils'; // Removed insightBoxPositions import
    ...
    setEcoIdeas(prevEcoIdeas => {
      ...
      if (toggledNote) {
        if (toggledNote.isConfirmed) {
          ...
          // Removed strategyPosition logic as insightBoxPositions is no longer available
          let initialX = 50; // Default X
          let initialY = 50; // Default Y

          const newRadarEcoIdea: RadarEcoIdea = {
            id: `radar-copy-${toggledNote.id}`,
