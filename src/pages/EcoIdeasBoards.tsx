                      ...
                      <div key={subStrategy.id} className="mb-6">
                        ...
                        <ul className="list-none space-y-1">
                          {subStrategy.guidelines.map((guideline, guidelineIndex) => {
                            ...
                            const isGuideline4_1_5 = guidelineId === '4.1.5';
                            ...
                            const isGuideline5_3_2 = guidelineId === '5.3.2';
                            const isGuideline5_3_3 = guidelineId === '5.3.3';
                            const isGuideline5_3_4 = guidelineId === '5.3.4';
                            const isGuideline5_3_5 = guidelineId === '5.3.5';
                            const isGuideline5_3_8 = guidelineId === '5.3.8';
                            
                            // New definitions for 5.4.x
                            const isGuideline5_4_1 = guidelineId === '5.4.1';
                            const isGuideline5_4_2 = guidelineId === '5.4.2';
                            const isGuideline5_4_3 = guidelineId === '5.4.3';
                            const isGuideline5_4_4 = guidelineId === '5.4.4';
                            const isGuideline5_4_5 = guidelineId === '5.4.5';
                            const isGuideline5_4_6 = guidelineId === '5.4.6';
                            const isGuideline5_4_7 = guidelineId === '5.4.7';
                            const isGuideline5_4_8 = guidelineId === '5.4.8';
                            
                            // New definitions for 5.5.x
                            const isGuideline5_5_1 = guidelineId === '5.5.1';
                            const isGuideline5_5_2 = guidelineId === '5.5.2';
                            const isGuideline5_5_3 = guidelineId === '5.5.3';
                            const isGuideline5_5_4 = guidelineId === '5.5.4';
                            const isGuideline5_5_5 = guidelineId === '5.5.5';

                            // New definitions for 5.6.x
                            const isGuideline5_6_1 = guidelineId === '5.6.1';
                            const isGuideline5_6_2 = guidelineId === '5.6.2';
                            ...
                            const isGuideline6_3_4 = guidelineId === '6.3.4';
                            const isGuideline6_3_5 = guidelineId === '6.3.5';
                            ...
                            const isGuideline7_2_5 = guidelineId === '7.2.5'; // NEW exclusion
                            ...
                            if (isGuideline5_1_1) {
                              ...
                              guidelineLink = "https://polimi365-my.sharepoint.com/:i:/g/personal/10004374_polimi_it/IQDmCPFebfbISayBCzcEkWkXAUWgoAqI2_VPLFqZyDUrK64?e=gS96eh";
                            ...
                            } else if (isGuideline5_3_2) {
                              guidelineLink = "https://polimi365-my.sharepoint.com/:i:/g/personal/10004374_polimi_it/IQBowayq_ZZoQoN1vkba8Rb0AZrVNvLAtkCYW3iVFhpjYzw?e=NpbpKx";
                            } else if (isGuideline5_3_3) {
                              guidelineLink = "https://polimi365-my.sharepoint.com/:i:/g/personal/10004374_polimi_it/IQBrJNXO-LMlQr6LTa2OMrTwATH-Nc3dpbWghrtcncEyfH0?e=hIEfax";
                            } else if (isGuideline5_3_4) {
                              guidelineLink = "https://polimi365-my.sharepoint.com/:i:/g/personal/10004374_polimi_it/IQAwkg8KPqzFSbRjgtz4W_jVAdthua0-W5sMQ-4WNONT8_4?e=gFQHXb";
                            } else if (isGuideline5_3_5) {
                              guidelineLink = "https://polimi365-my.sharepoint.com/:i:/g/personal/10004374_polimi_it/IQDwfsrHt6h0Q7uBx0jedxlzAbU7_Vz567EwSQJcdj2tuAQ?e=zJKfyt";
                            } else if (isGuideline5_4_1) {
                              ...
                              guidelineLink = "https://polimi365-my.sharepoint.com/:i:/g/personal/10004374_polimi_it/IQB637fqdHCTR5eCbRadSeVGAW_lQyPeaW0yjzyyrl4ne20?e=Aa3UdV";
                            ...
                            } else if (isGuideline5_5_3) {
                              guidelineLink = "https://polimi365-my.sharepoint.com/:i:/g/personal/10004374_polimi_it/IQB8XjOnyPqJTZLiO0irzeyTAeemU_eRctJU0E9wZNDDttY?e=tIggCb";
                            } else if (isGuideline5_6_2) {
                            ...
                            // --- NEW Specific links for Strategy 7 exceptions ---
                                ...
                                guidelineLink = "#";
                            } else if (isGuideline7_4_5) { // NEW: Link moved from 7.4.4
                            ...
                            const shouldHideGenericExample = isSubStrategy1_1_4 || isGuideline1_1_1_7 || isSecondGuidelineOf1_2 || isFirstOverallGuideline || isFourthOverallGuideline || isFirstGuidelineOf1_5 || isFourthGuidelineOf1_5 ||
                                ...
                                // NEW: Strategy 7 exclusions (excluding 7.1.6, 7.3.2, 7.4.1, 7.4.2, 7.4.5)
