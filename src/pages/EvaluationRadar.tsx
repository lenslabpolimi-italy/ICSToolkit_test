      ...
      <div className="relative max-w-7xl mx-auto h-[600px] flex justify-center items-center mt-32">
        {strategies.length > 0 ? (
          <>
            ...
            {/* Render RadarStickyNotes directly in the main container */}
            {radarEcoIdeas.length > 0 ? (
              ...
              <p className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm text-gray-500 italic font-roboto-condensed">No confirmed ideas yet.</p>
            )}
          </>
        ) : (
