...
const EvaluationRadar: React.FC = () => {
  const { strategies, evaluationChecklists, setRadarChartData, radarChartData, qualitativeEvaluation, ecoIdeas } = useLcd();
  ...
  // Filter and group confirmed eco-ideas (no longer rendered, but still used for context if needed elsewhere)
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md relative min-h-[calc(100vh-200px)] font-roboto">
      ...
      {/* Removed the "Confirmed Eco-Ideas" section */}
