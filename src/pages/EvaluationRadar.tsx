...
const insightBoxPositions: { [key: string]: { top: number | string; left?: number | string; right?: number | string; transform?: string; } } = {
  ...
  '4': { top: 300, left: '50%', transform: 'translateX(-50%)' }, // Adjusted to be above the legend, below radar
...
const EvaluationRadar: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md relative min-h-[calc(100vh-200px)] font-roboto">
      ...
      <div className="relative max-w-7xl mx-auto h-[600px] flex justify-center items-center mt-52"> {/* Changed mt-40 to mt-52 */}
      ...
      <div className="mt-36 pt-8 border-t border-gray-200"> {/* Changed mt-12 to mt-36 */}
