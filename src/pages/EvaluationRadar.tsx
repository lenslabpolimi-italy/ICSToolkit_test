...
const EvaluationRadar: React.FC = () => {
  ...
  const insightBoxPositions: { [key: string]: React.CSSProperties } = {
    ...
    '2': { top: '5%', left: 'calc(75% + 32px)' }, // Right side, upper (adjusted from 10% to 5%, and 16px to 32px)
    '3': { top: '40%', left: 'calc(75% + 32px)' }, // Right side, middle (adjusted 16px to 32px)
    '4': { top: '70%', left: 'calc(75% + 32px)' }, // Right side, lower (adjusted 16px to 32px)
    '5': { top: '70%', right: 'calc(75% + 32px)' }, // Left side, lower (adjusted 16px to 32px)
    '6': { top: '40%', right: 'calc(75% + 32px)' }, // Left side, middle (adjusted 16px to 32px)
    '7': { top: '5%', right: 'calc(75% + 32px)' }, // Left side, upper (adjusted from 10% to 5%, and 16px to 32px)
  };
